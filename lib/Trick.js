...
function Trick(play, level, trumpSuit) {
  ...
  this.leadSuit = ShengJi.isTrump(level, trumpSuit, cards[0]) ? trumpSuit : cards[0]['suit'];
}
...
Trick.prototype.play = function(newPlay, trumpSuit, level) {
  ...
  if (ShengJi.isStronger(this.leadingPlay, newCards, this.leadSuit, trumpSuit, level)) {
