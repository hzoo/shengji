...
describe('Trick', function(suite) {
	...
	it('Creates a new Trick and sets the properties correctly', function(t) {
		...
		t.equals(trick.leadSuit, ShengJi.cardSuit.SPADES, 'Sets the lead suit to trump when level value card is played');
		trick = new Trick(joker, ShengJi.cardValue.TWO, ShengJi.cardSuit.DIAMONDS);
		t.equals(trick.leadSuit, ShengJi.cardSuit.DIAMONDS, 'Sets the lead suit to trump when joker is played');
	});
